...
correct_mitigation_examples_list = [
    Mitigation(
        mitigation="Retrofitting existing structures for increased seismic resilience",
        activity="Construction of high-rise buildings in an earthquake-prone zone",
        hazard="Earthquake",
        how_it_harms="Structural damage",
        who_it_harms="Occupants of the buildings"
    ),
    Mitigation(
