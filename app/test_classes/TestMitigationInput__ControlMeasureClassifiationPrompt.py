...
class TestMitigationInput__ControlMeasureClassifiationPrompt(TestControlMeasureClassificationPrompt):
    def __init__(self, 
                    LLM: LLMCaller,
...
class TestMitigationInput__ControlMeasureClassifiationPrompt__OnSingleExample(TestMitigationInput__ControlMeasureClassifiationPrompt):
    def __init__(self,
                 LLM: LLMCaller,
                 expected_output,
                 input_object):
