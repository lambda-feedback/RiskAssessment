...
#     activity="",
#     hazard="Musical Instrument",
#     hazard_event ="Instrument plays loud noise",
#     who_it_harms="Everyone present",
#     how_it_harms="Hearing damage.",
...
#     hazard="Toxic welding fumes",
#     hazard_event ="Inhaling toxic welding fumes",
#     how_it_harms="Respiratory problems, lung damage, and long-term health issues.",
...
#     activity="Using a trombone as a demonstration for a TPS presentation",
#     hazard='Musical Instrument',
#     hazard_event ="Instrument hits student",
...
#     activity="Using a trombone as a demonstration for a TPS presentation",
#     hazard='Musical Instrument',
#     hazard_event ="Musical instrument plays loud noise",
#     who_it_harms="Everyone present",
#     how_it_harms="Hearing damage.",
#     uncontrolled_likelihood="4",
#     uncontrolled_severity="1",
...
# #     activity="Using a trombone as a demonstration for a TPS presentation",
# #     hazard_event ="Water from instrument",
# #     who_it_harms="Audience",
...
#     hazard='Ink',
#     hazard_event ="Ink is spilled onto students face",
...
#     mitigation="Wash your eyes with clean water", # reduces severity after hazard_event  has occurred
#     controlled_likelihood="1",
...
# #     uncontrolled_severity="3",
# #     uncontrolled_risk="6",
# #     prevention="Wear safety glasses", # reduces likelihood of hazard_event  occurring
# #     mitigation="First aid", # reduces severity after hazard_event  has occurred
# #     controlled_likelihood="1",
# #     controlled_severity="3",
# #     controlled_risk="3",
# #     prevention_prompt_expected_class='mitigation',
...
#     activity="Fluids laboratory",
#     hazard='Electronics',
#     hazard_event ="Student touches electronics with wet hands",
#     who_it_harms="Students",
#     how_it_harms="Electric shock",
#     uncontrolled_likelihood="3",
#     uncontrolled_severity="3",
#     uncontrolled_risk="9",
#     prevention="Students should make sure they touch electronics only with dry hands", # reduces likelihood of hazard_event  occurring
#     mitigation="Unplug the pump and call for urgent medical assistance", # reduces severity after hazard_event  has occurred
...
#     uncontrolled_severity="3",
#     uncontrolled_risk="9",
#     mitigation="Students should make sure they touch electronics only with dry hands", # reduces likelihood of hazard_event  occurring
#     prevention="Unplug the pump and call for urgent medical assistance", # reduces severity after hazard_event  has occurred
#     controlled_likelihood="2",
#     controlled_severity="3",
#     controlled_risk="6",
#     prevention_prompt_expected_class='mitigation',
...
#     prevention="Put all belongings away from footpaths", # This reduces likelihood of hazard_event  occurring and is therefore a prevention measure
#     mitigation="Take care when walking around", # This reduces likelihood of hazard_event  occurring and is therefore a prevention measure 
#     controlled_likelihood="1",
#     controlled_severity="2",
#     controlled_risk="2",
#     prevention_prompt_expected_class='prevention',
...
#     activity="Fluids laboratory",
#     hazard='Water spilt on floor',
#     hazard_event ="Students slipping on water spilt on the floor",
#     who_it_harms="Students",
#     how_it_harms="Impact Injury",
#     uncontrolled_likelihood="3",
#     uncontrolled_severity="2",
...
#     hazard_event ="Syringes with sharp needles can pierce the skin",
#     who_it_harms="Students",
#     how_it_harms="Bleeding",
#     uncontrolled_likelihood="3",
#     uncontrolled_severity="3",
#     uncontrolled_risk="9",
...
# #     hazard_event ='Demonstration with ruler, styrofoam and bbq sticks. I will be flicking the ruler while clamping it to a table. The bbq sticks will be stuck in the styrofoam and I will shake to show resonance',
...
#     hazard='Paper Plane',
#     hazard_event ='Paper Plane is thrown and hits audience member.',
#     who_it_harms='Audience',
#     how_it_harms='Impact injury.',
#     uncontrolled_likelihood='4',
#     uncontrolled_severity='2',
...
#     hazard_event ='Equipment dropped on feet.',
...
#     hazard='Sharp Edge of propellor blade',
#     hazard_event ='Sharp Edge of propellor blade is touched',
...
#     activity='Bringing in a drone and two empty Li-Po batteries',
#     hazard='Li-Po battery',
#     hazard_event ='Li-Po battery could heat up and cause a fire',
...
#     controlled_risk='2',
#     prevention_prompt_expected_class='prevention',
#     mitigation_prompt_expected_class='prevention', # it is both mitigation and prevention
#     prevention_protected_clothing_expected_output=False,
#     mitigation_protected_clothing_expected_output=False,
#     prevention_first_aid_expected_output=False,
#     mitigation_first_aid_expected_output=False,
...
#     hazard='Spring contraption',
#     hazard_event ='Contraption falls onto demonstrator',
...
# RA_zip_tie = RiskAssessment(
#     activity='Using a spring contraption as a demonstration for a TPS presentation',
#     hazard='Zip tie',
#     hazard_event ='Cut Zip tie flies and hits audience member',
#     who_it_harms='Audience',
#     how_it_harms='Impact injury.',
#     uncontrolled_likelihood='4',
#     uncontrolled_severity='2',
...
#     hazard='Pencil lead',
#     hazard_event ='Pencil lead breaks and becomes a projectile, hitting someone',
...
#     hazard='Horse',
#     hazard_event ='Horse kicks rider',
...
#     RA_14, RA_15, RA_17, RA_18, RA_19, RA_zip_tie,
#     RA_23,
